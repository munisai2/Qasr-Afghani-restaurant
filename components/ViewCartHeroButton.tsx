    ...
    <AnimatePresence mode="wait">
      {itemCount > 0 ? (
        <motion.button
          ...
          exit={{ opacity: 0, y: -10 }}
          onClick={openCart}
          className="group relative overflow-hidden inline-flex items-center gap-3 bg-gold text-palace-black font-body font-semibold text-sm tracking-[0.25em] uppercase px-10 py-4 rounded-none border border-gold"
        >
